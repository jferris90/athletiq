      ...
      <div className="container mx-auto px-4 h-full max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Have a voice conversation wih our AI assistant to create your personalized plan
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="bg-card/90 backdrop-blur-sm border border-border overflow-hidden relative">
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              <h2 className="text-xl font-bold text-foreground">AthletiQ AI</h2>
              ...
              <div className={`mt-4 flex items-center gap-2 px-3 py-1 rounded-full bg-card border border-border ${isSpeaking ? "border-primary" : ""}`}>
                ...
                <span className="text-sm txt-muted-foreground">
                  {isSpeaking
                    ? "Speaking..."
                    : callActive
                      ? "Listening..."
          ...
          <Card className={`bg-card/90 backdrop-blur-sm border overflow-hidden relative`}>
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              {/* USER READY TEXT */}
              <div className={`mt-4 flex items-cnter gap-2 px-3 py-1 rounded-full bg-card border`}>
              ...
              {messages.map((msg, index) => (
                <div key={index} className="message-item animate-fadeIn">
                  <div className="font-semibold text-xs text-muted-foreground mb-1">
                    {msg.role === "assistant" ? "AthletiQ AI" : "You"}:
                  </div>
